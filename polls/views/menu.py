from polls.commands import create_question_command, get_question_command, get_all_question_command
...
def execute():
    ...
    while option != 6:
        ...
        print('\n')
        print('================================== MENU: ==================================\n')
        print('| 1 - CREATE | 2 - GET | 3 - GET ALL | 4 - UPDATE | 5 - DELETE | 6 - EXIT |\n')
        print('===========================================================================\n')
